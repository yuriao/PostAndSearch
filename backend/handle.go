...
func uploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("%v %v %v", r.Method, r.URL, r.Proto)
	if r.Method == "OPTIONS" {
...
func searchHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("search CHECK: %v %v %v", r.Method, r.URL, r.Proto)
	if r.Method == "OPTIONS" {
		return
	}
...
func signinHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("signin CHECK: %v %v %v", r.Method, r.URL, r.Proto)
	if r.Method == "OPTIONS" {
		return
	}
...
func startupTestHandler(w http.ResponseWriter, r *http.Request) {
